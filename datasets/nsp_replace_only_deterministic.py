...
@register_dataset(name="nsp_replace_only_deterministic")
class NSPReplaceOnlyDeterministic(data.Dataset):
    ...
    def replace_tokens(self, input_x, alternate_x, subsample_idxs, seed_n=0):
        '''
            input_x is [n_elec, d]
        '''
    ...
    def __getitem__(self, idx: int):
        ...
        input_x_1, replace_labels_1 = self.replace_tokens(input_x_1, input_x_3, channel_subsample_1, seed_n=idx)
        ...
        input_x_2, replace_labels_2 = self.replace_tokens(input_x_2, input_x_3, channel_subsample_2, seed_n=idx)
